			...
			<div className="space-y-14">
				...
				<section className="space-y-4">
					...
					<p className="leading-7 opacity-70">
						...
						handles your information, you can contact
					</p>

					<div className="rounded-2xl border px-5 py-3 w-fit mx-auto space-y-3">
						<a
						...
						<div>
							<p className="font-bold">Muhammad Insaf</p>
							<p className="text-sm">Founder and CEO @Minarat</p>
						</div>
					</div>
				</section>
			</div>
